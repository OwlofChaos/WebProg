...
<body>
    ...
    <div class="content">
     ...
     <button style="font-size: 15px; background-color: #FFFFFF;" onclick="window.location.href='<?php echo e(route('donate.index')); ?>'">DONATE NOW</button>
     <div class="rectangle">
        <h3 class="raised_1">
            Raised so far
        </h3>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Downloads\Webprog\WebProg\WebProg\resources\views/home.blade.php ENDPATH**/ ?>